...
<div id="shopping-cart-modal" class="w3-modal">
	...
	<div class="w3-row" id="add-to-cart">
		...
		<div class="w3-col m8 l8">
			<div class="w3-row">
				<div class="w3-col s12 m6 l6" id="product-detail-image">
					<img src="${pageContext.request.contextPath}/${product.linkImg }" alt="">
				</div>
				...
				<div class="w3-col s12 m6 l6">
					<div class="product-basic-info">
						...
						<div class="form-group">
							<input type="text" class="quantity-input" name="order-quantity"
								value="1">
						...
						<button id="product-detail-add-cart">Add to cart</button>
	...
	<div class="w3-row" id="product-specs">
		<div class="w3-col s2 m2 l2">
			<p></p>
		</div>
		<div class="w3-col s8 m8 l8">
			<div class="w3-card-4">
				<header class="w3-container specs">
					<h1>Specifications</h1>
				</header>

				<div class="w3-container">
					<h4>Screen</h4>
					<p>Screen Size: 17.3&#8243; Screen Resolution: 1920 x 1080
						Screen Type: LED</p>
					<h4>Processor</h4>
					<ul>
						<li>Processor Model: 6700HQ</li>
						<li>Processor Type: Intel Core i7 Processor</li>
					</ul>
					<h4>Memory</h4>
					<ul>
						<li>RAM: 16 GB</li>
