...
<body>
	<div id="header">
		...
		<form action="SearchProductServlet">
			...
			<div id="searchIcon">
				<input type="image" value="submit" src="images/search.png"
					alt="submit Button" onMouseOver="this.src='images/search.png'">
			</div>
		</form>

		<div>
			<a id="giohang" href="Cart.jsp"> <img src="images/giohang.png"></a>
		</div>
	</div>
	...
	<div id="main">
		<div id="left">
			...
			%>
			<div class="tv">
				<a href="ProductServlet?id=<%=p.getId()%>"> <img
					src="<%=p.getLinkImg()%>"></a>
				<h2><%=p.getName()%></h2>
			</div>
		...
		<div id="right">
			...
			<form action="">
				...
				<input type="radio" name="cost" value="female">10-15 milions<br>
				<input type="radio" name="cost" value="other"> Upper 15
				milions<br>
			</form>
			<div class="map">
				<iframe
