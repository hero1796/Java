...
<body>
	...
	<input style="text-align: center;" type="button" value="Add product" onclick="callservletAdd()"/>
	<table border="1px">
		<tr>
			<th>ID</th>
			<th>Name</th>
		...
		<tr>
			...
			<td><input type="button" value="Delete" onclick="callservletDelete(<%=p.getId()%>)" /></td>
		</tr>
